...
@section('content')
    ...
    <div class="level-left">
        <h1 class="title">Orders</h1><br><br>
    </div>
    ...
    <table class="table is-narrow is-hoverable is-fullwidth">
        ...
        @foreach($products as $product)
            <tr>
                ...
                <td>
                    <b-button tag="a"  href="product/{{$product->id}}/edit"  size="is-small"  type="is-warning is-light"> <span class="icon is-small"><i class="mdi mdi-pencil-outline"></i></span>Re intentar pago</b-button>
                    &nbsp;
